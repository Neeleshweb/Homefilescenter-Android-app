...
public class Page13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg=(RadioGroup)findViewById(R.id.r13);
        tv1=(TextView)findViewById(R.id.page13);
        btn=(Button)findViewById(R.id.b13);
            ...
            public void onClick(View v) {
                ...
                switch (ids) {
                    case R.id.radioButton49 :
                        ...
                        get=getIntent();
                        a=get.getIntExtra("val12",0);
                        b=num.calculatescore1(value2);
                        sum=a+b;



                        Intent send = new Intent(Page13.this, Page14.class);
                    ...
                    case R.id.radioButton50 :
                        ...
                        Intent send1=new Intent(Page13.this,Page14.class);
                    ...
                    case R.id.radioButton51 :
                        ...
                        Intent send2=new Intent(Page13.this,Page14.class);
                    ...
                    case R.id.radioButton52 :
                        ...
                        Intent send8=new Intent(Page13.this,Page14.class);
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(R.id.radioButton49==checkedId) {
                    value=0;



                }
                else if(R.id.radioButton50==checkedId) {
                    value1=0;

                }
                else if(R.id.radioButton51==checkedId) {
                    value2=1;

                }
                else if(R.id.radioButton52==checkedId) {
                    value3=0;
    ...
    protected void exitByBackKey() {
        ...
        AlertDialog.Builder make = new AlertDialog.Builder(Page13.this);
        make.setTitle("SORRY !!");

...
public class Page8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg=(RadioGroup)findViewById(R.id.r8);
        tv1=(TextView)findViewById(R.id.page8);
        btn=(Button)findViewById(R.id.b8);
            ...
            public void onClick(View v) {
                ...
                switch (ids) {
                    case R.id.radioButton29 :
                        ...
                        Intent send = new Intent(Page8.this, Page9.class);
                    ...
                    case R.id.radioButton30 :
                        ...
                        Intent send1=new Intent(Page8.this,Page9.class);
                    ...
                    case R.id.radioButton31 :
                        ...
                        Intent send2=new Intent(Page8.this,Page9.class);
                    ...
                    case R.id.radioButton32 :
                        ...
                        Intent send8=new Intent(Page8.this,Page9.class);
    ...
    protected void exitByBackKey() {
        ...
        AlertDialog.Builder make = new AlertDialog.Builder(Page8.this);
        make.setTitle("SORRY !!");

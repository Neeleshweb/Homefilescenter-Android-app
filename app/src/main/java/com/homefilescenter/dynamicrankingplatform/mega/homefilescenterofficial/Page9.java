...
public class Page9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg=(RadioGroup)findViewById(R.id.r9);
        tv1=(TextView)findViewById(R.id.page9);
        btn=(Button)findViewById(R.id.b9);
            ...
            public void onClick(View v) {
                ...
                switch (ids) {
                    case R.id.radioButton33 :
                        ...
                        Intent send = new Intent(Page9.this, Page10.class);
                    ...
                    case R.id.radioButton34 :
                        ...
                        Intent send1=new Intent(Page9.this,Page10.class);
                    ...
                    case R.id.radioButton35 :
                        ...
                        Intent send2=new Intent(Page9.this,Page10.class);
                    ...
                    case R.id.radioButton36 :
                        ...
                        Intent send8=new Intent(Page9.this,Page10.class);
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(R.id.radioButton33==checkedId) {
                    value=0;
                ...
                else if(R.id.radioButton36==checkedId) {
                    value3=1;
    ...
    protected void exitByBackKey() {
        ...
        AlertDialog.Builder make = new AlertDialog.Builder(Page9.this);
        make.setTitle("SORRY !!");
